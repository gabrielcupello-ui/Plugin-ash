...
class Arc_Portal_App_Registry {
	...
	private function __construct() {
		$this->defaults = array(
			'time_clock' => array(
				'label'       => __( 'Control Horario', 'arc-portal' ),
				'url'         => '',
				'icon'        => 'clock',
				'enabled'     => true,
				'description' => __( 'Registra tu entrada, salida y descansos.', 'arc-portal' ),
				'target'      => 'iframe',
				'capability'  => 'read',
				'order'       => 10,
			),
			'eod_report' => array(
				...
				'icon'        => 'file-text',
				'enabled'     => true,
				'description' => __( 'Envía tu resumen diario de trabajo.', 'arc-portal' ),
				'target'      => 'iframe',
				'capability'  => 'read',
				'order'       => 20,
			),
			'hr'         => array(
				'label'       => __( 'Recursos Humanos', 'arc-portal' ),
				'url'         => '',
				'icon'        => 'users',
				'enabled'     => true,
				'description' => __( 'Solicitudes, entrevistas y gestión de talento.', 'arc-portal' ),
				'target'      => 'iframe',
				'capability'  => 'read',
				'order'       => 30,
			),
			'task_app'   => array(
				...
				'icon'        => 'check-square',
				'enabled'     => true,
				'description' => __( 'Proyectos, tareas y tablero Kanban.', 'arc-portal' ),
				'target'      => 'new_tab',
				'capability'  => 'read',
				'order'       => 40,
			),
