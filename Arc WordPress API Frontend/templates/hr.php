...
<div class="max-w-3xl mx-auto p-6 font-sans text-gray-900" id="arc-hr-form">
	<div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
		<h2 class="text-2xl font-bold mb-2"><?php esc_html_e( 'Apply to open positions', 'arc-api-frontend' ); ?></h2>
		<p class="text-gray-500 mb-6"><?php esc_html_e( 'Complete your information to apply.', 'arc-api-frontend' ); ?></p>

		<form id="arc-hr-form" class="space-y-5">
			<div class="grid grid-cols-1 md:grid-cols-2 gap-5">
				<div>
					<label class="block text-sm font-semibold text-gray-700 mb-1"><?php esc_html_e( 'First name', 'arc-api-frontend' ); ?></label>
				...
				<div>
					<label class="block text-sm font-semibold text-gray-700 mb-1"><?php esc_html_e( 'Last name', 'arc-api-frontend' ); ?></label>
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-5">
				<div>
					<label class="block text-sm font-semibold text-gray-700 mb-1"><?php esc_html_e( 'Phone', 'arc-api-frontend' ); ?></label>
				...
				<div>
					<label class="block text-sm font-semibold text-gray-700 mb-1"><?php esc_html_e( 'Years of experience', 'arc-api-frontend' ); ?></label>
			...
			<div>
				<label class="block text-sm font-semibold text-gray-700 mb-1"><?php esc_html_e( 'Positions worked', 'arc-api-frontend' ); ?></label>
				<textarea id="arc-hr-positions" name="positions_worked" rows="2" placeholder="<?php esc_attr_e( 'Accountant, analyst, etc.', 'arc-api-frontend' ); ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none resize-y"></textarea>
			</div>
			<div>
				<label class="block text-sm font-semibold text-gray-700 mb-1"><?php esc_html_e( 'Domain experience', 'arc-api-frontend' ); ?></label>
				<textarea id="arc-hr-domain" name="domain_experience" rows="2" placeholder="<?php esc_attr_e( 'Taxes, payroll, etc.', 'arc-api-frontend' ); ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none resize-y"></textarea>
			</div>
			<div class="grid grid-cols-1 md:grid-cols-2 gap-5">
				<div>
					<label class="block text-sm font-semibold text-gray-700 mb-1"><?php esc_html_e( 'Accounting software', 'arc-api-frontend' ); ?></label>
			...
			<div>
				<label class="block text-sm font-semibold text-gray-700 mb-1"><?php esc_html_e( 'Additional summary', 'arc-api-frontend' ); ?></label>
			...
			<button type="submit" class="inline-flex items-center px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition" data-loading-text="<?php esc_attr_e( 'Submitting...', 'arc-api-frontend' ); ?>"><?php esc_html_e( 'Submit application', 'arc-api-frontend' ); ?></button>
		</form>
		<div id="arc-hr-message" class="hidden mt-4 p-4 rounded-lg"></div>
	</div>

	<?php if ( empty( $app['endpoint'] ) ) : ?>
		<div class="mt-6 bg-red-50 border border-red-200 text-red-800 rounded-lg p-4"><?php esc_html_e( 'The Human Resources endpoint is not configured.', 'arc-api-frontend' ); ?></div>
	<?php endif; ?>
</div>
