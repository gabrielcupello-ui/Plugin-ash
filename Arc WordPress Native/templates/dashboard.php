...
<div class="max-w-6xl mx-auto p-6 font-sans text-gray-900">
	<div class="flex items-center justify-between mb-8">
		<h1 class="text-3xl font-bold text-gray-900"><?php esc_html_e( 'Panel Nativo ARC', 'arc-native' ); ?></h1>
	...
	<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8" data-arc-native-stats>
		<div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm text-center">
			...
			<div class="text-sm text-gray-500 mt-1"><?php esc_html_e( 'Horas esta semana', 'arc-native' ); ?></div>
		</div>
		<div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm text-center">
			<div class="text-4xl font-bold text-sky-500" data-stat="eod_count">-</div>
			<div class="text-sm text-gray-500 mt-1"><?php esc_html_e( 'EODs enviados', 'arc-native' ); ?></div>
		</div>
		<div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm text-center">
			<div class="text-4xl font-bold text-sky-500" data-stat="active_tasks">-</div>
			<div class="text-sm text-gray-500 mt-1"><?php esc_html_e( 'Tareas activas', 'arc-native' ); ?></div>
		</div>
		<div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm text-center">
			<div class="text-4xl font-bold text-sky-500" data-stat="candidates">-</div>
			<div class="text-sm text-gray-500 mt-1"><?php esc_html_e( 'Candidatos RRHH', 'arc-native' ); ?></div>
		</div>
	</div>

	<h2 class="text-xl font-bold text-gray-900 mb-4"><?php esc_html_e( 'Módulos', 'arc-native' ); ?></h2>
