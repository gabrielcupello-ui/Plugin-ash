...
<div class="max-w-3xl mx-auto p-6 font-sans text-gray-900">
	<div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
		<h2 class="text-2xl font-bold mb-6 text-gray-900"><?php esc_html_e( 'Submit EOD Report', 'arc-native' ); ?></h2>
		<form class="space-y-5" id="arc-native-eod-form">
			<div class="grid grid-cols-1 md:grid-cols-2 gap-5">
				<div>
					<label class="block text-sm font-semibold text-gray-700 mb-1"><?php esc_html_e( 'Date', 'arc-native' ); ?></label>
				...
				<div>
					<label class="block text-sm font-semibold text-gray-700 mb-1"><?php esc_html_e( 'Hours worked', 'arc-native' ); ?></label>
			...
			<div>
				<label class="block text-sm font-semibold text-gray-700 mb-1"><?php esc_html_e( 'Work summary', 'arc-native' ); ?></label>
			...
			<div>
				<label class="block text-sm font-semibold text-gray-700 mb-1"><?php esc_html_e( 'Shipped today', 'arc-native' ); ?></label>
			...
			<div>
				<label class="block text-sm font-semibold text-gray-700 mb-1"><?php esc_html_e( 'In progress', 'arc-native' ); ?></label>
			...
			<div>
				<label class="block text-sm font-semibold text-gray-700 mb-1"><?php esc_html_e( 'Blockers / Risks', 'arc-native' ); ?></label>
			...
			<div>
				<label class="block text-sm font-semibold text-gray-700 mb-1"><?php esc_html_e( 'Top 3 priorities for tomorrow', 'arc-native' ); ?></label>
			...
			<p class="pt-2">
				<button type="submit" class="inline-flex items-center px-6 py-2.5 bg-sky-500 hover:bg-sky-600 text-white font-medium rounded-lg transition"><?php esc_html_e( 'Submit report', 'arc-native' ); ?></button>
			</p>
		</form>
	</div>
</div>
